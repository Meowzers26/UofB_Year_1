...
int triangle(long int a, long int b, long int c) {
...
// Run the program or, if there are50000002 no arguments, test it.
int main(int n, char *args[n]) {
    ...
    if (n == 1) {
        ...
        // long int powTotal = pow(a, 2) + pow(b, 2);
        // long int powA = pow(a, 2);
        // long int powB = pow(b, 2);
        // long int powC = pow(c, 2);
        // printf("%li\n", powTotal);
        // printf("%li\n", powA);
        // printf("%li\n", powB);
        // printf("%li\n", powC);
